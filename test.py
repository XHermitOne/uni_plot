...
commands=(
	  ...
	  #'./uni_plot --version',
          ...
          './uni_plot --debug --src=./examples/graphic/line.txt --out=./test/output.png --xtype=N --ytype=N --width=480 --height=480 --pen0_color=LIGHTBLUE --scene=0/0,50/50 --dx=10 --dy=10',
          )
